...
import { addPatient, getDoctors, getBeds } from "../services/api";
...
export default function PatientRegistration({ onNavigate, addToast }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const severityScore = form.severity === "Critical" ? 90 : form.severity === "Major" ? 70 : form.severity === "Moderate" ? 50 : 20;
