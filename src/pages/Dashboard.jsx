...
export default function Dashboard({ onNavigate }) {
  const { patients, doctors, beds } = useApp();
  const active   = patients.filter(p => p.status !== "Discharged");
  const critical  = active.filter(p => p.severity === "Critical").length;
  ...
  const metrics = [
    { title: "Total Active Patients",  value: active.length, icon: "bi-people",       cls: "metric-primary",  footer: "Admitted across departments" },
    { title: "Critical Cases",         value: critical,       icon: "bi-heart-pulse",  cls: "metric-accent",   footer: "Requires urgent response" },
    { title: "Bed Occupancy Rate",     value: `${rate}%`,     icon: "bi-hospital",     cls: "metric-warning",  footer: `${occupied} of ${beds.length} beds occupied` },
    { title: "Available Doctors",      value: available,      icon: "bi-person-check", cls: "metric-success",  footer: `${available} responders ready` },
  ];
      ...
      <div className="row g-4 mb-4">
        <div className="col-lg-5 col-xl-4">
          <div className="glass-panel p-4 h-100">
            ...
            <div style={{ height: 280 }}><SeverityChart /></div>
          </div>
        </div>
        <div className="col-lg-7 col-xl-8">
          <div className="glass-panel p-4 h-100">
            ...
            <div style={{ height: 280 }}><DepartmentChart /></div>
          </div>
        </div>
      </div>
      ...
      <div className="row g-4 mb-4">
        <div className="col-lg-7 col-xl-8">
          <div className="glass-panel p-4 h-100">
            ...
            <div style={{ height: 310 }}><AdmissionsChart /></div>
          </div>
        </div>
        <div className="col-lg-5 col-xl-4">
          <div className="glass-panel p-4 h-100">
