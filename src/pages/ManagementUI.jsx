        ...
        <div className="dropdown ms-2">
          ...
          <ul className="dropdown-menu dropdown-menu-end shadow-sm">
            ...
            {DOC_STATUS_OPTIONS.map(s => (
              <li key={s}>
                <button className="dropdown-item" onClick={() => onStatusChange(doc.name, s)}>
                  Set {s}
                </button>
              </li>
            ))}
              ...
              <div className="dropdown">
                ...
                <ul className="dropdown-menu dropdown-menu-end shadow-sm" style={{ fontSize: "0.85rem" }}>
                  {BED_STATUS_OPTIONS.map(s => (
                    <li key={s}><button className="dropdown-item" onClick={() => onStatusChange(bed.id, s)}>Mark {s}</button></li>
                  ))}
                </ul>
              </div>
            )}
